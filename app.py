...
- Produce a short summary of about 50 words (30–50 words).

QUALITY REQUIREMENTS (INTENTIONALLY LOW)
- The summary should be emotional, exaggerated, and dramatic.
- It may overlook the main idea or mix unrelated details.
- It should loosely reference the text but may distort or misrepresent parts of it.
- It should be vague, unclear, and not fully coherent.
- Do NOT aim for accuracy or completeness.
- You may include minor irrelevant comments or speculation.
- Avoid precise paraphrasing; do not try to capture the real meaning carefully.

DIALOGUE ROUNDS
Round 1 → produce first summary + ask a question (the question should also be vague).
